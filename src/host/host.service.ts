...
export class HostService {
   ...
   * @param {Omit<HostInfo, "uid">} hostInfo - The new host information to apply.
   ...
   * @throws {UserError} When user is not found.
   */
  async findHost(userId: string, hostUid: string): Promise<HostInfo> {
